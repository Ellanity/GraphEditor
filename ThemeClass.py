...
class Theme:
    def __init__(self):
        ...
        self.INFO_AREA_COLOR = (255, 255, 255)
...
class BlueLightTheme(Theme):
    def __init__(self):
        ...
        self.INFO_TEXT_COLOR = (14, 36, 97)
        self.INFO_AREA_COLOR = (222, 229, 245)
...
class OrangeDarkTheme(Theme):
    def __init__(self):
        ...
        self.ACTIVE_AREA_COLOR = self.INFO_AREA_COLOR = (40, 40, 40)
        self.CIRCLE_COLOR = self.INFO_TEXT_COLOR = (255, 128, 0)
